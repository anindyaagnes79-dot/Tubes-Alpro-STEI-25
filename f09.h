...
// ==========================================
// 2. STRUKTUR DATA BARU UNTUK F09 (WEB GRAPH)
// ==========================================
...
// ==========================================
// 3. STATE GLOBAL NAVIGASI & GRAF (STATIC)
// ==========================================

/*
 * Menggunakan 'static' membuat variabel ini otomatis dialokasikan
 * dan hanya berlaku di dalam scope file yang meng-include header ini.
 * Anda tidak perlu lagi menulis deklarasinya di file main.c.
 */
...
// ==========================================
// 4. IMPLEMENTASI FUNGSI HELPER & MODUL UTAMA
// ==========================================
